    ...
    server::new(|| { //使用应用工厂创建新的http服务器
        vec![
             App::
                 ...
                 .resource("hh",|r|{r.f(|_:&HttpRequest|{"hello  visitor !!!!"})})
                 .boxed(),//多状态 必须使用这个方法
             App::with_state(AppState{counter: Cell::new(0)})//多状态应用情况之一
                 //new()
             ...
             App::with_state(AppState2{counter: Cell::new(0)}) //多状态应用情况之一
